...
class CourseContentController extends Controller
{
     ...
     */
    public function show(Request $request, Course $course, CourseContent $courseContent)
    {
        ...
        return view('instructor.courses.contents-show-tutor', compact('course', 'courseContent'));
    }

    /**
     * Show the form for editing the specified course content
     */
    public function edit(Request $request, Course $course, CourseContent $courseContent)
    {
        // Pastikan materi milik kursus yang dimaksud
        if ($courseContent->course_id !== $course->id) {
            abort(404);
        ...
        return view('instructor.courses.contents-edit-tutor', compact('course', 'courseContent', 'topics'));
    }
     ...
     */
    public function destroy(Request $request, Course $course, CourseContent $courseContent)
    {
        // Pastikan materi milik kursus yang dimaksud
        if ($courseContent->course_id !== $course->id) {
            abort(404);
     ...
     */
    public function toggleStatus(Request $request, Course $course, CourseContent $courseContent)
    {
        // Pastikan materi milik kursus yang dimaksud
        if ($courseContent->course_id !== $course->id) {
            abort(404);
