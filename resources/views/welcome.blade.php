            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="space-y-8">
                    <div class="space-y-4">
                        ...
                        <p class="text-xl md:text-2xl text-blue-100 leading-relaxed">
                            Platform pembelajaran online terbaik dengan pengajar berpengalaman.
                    ...
                    <div class="grid grid-cols-3 gap-8 pt-8">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-blue-100">Pengajar</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="relative z-10">
                        <img src="{{ asset('images/theskills.png') }}" alt="Students learning online"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center group">
                    <div
                        class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-blue-200 transition-colors">
                        <i class="fas fa-chalkboard-teacher text-2xl text-blue-600"></i>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Pengajar Berpengalaman</h3>
                    <p class="text-gray-600">
                        Belajar dari instruktur yang sudah berpengalaman di bidangnya dengan metode pengajaran yang terbukti
                        efektif
                    </p>
                </div>
                ...
                <div class="text-center group">
                    <div
                        class="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-purple-200 transition-colors">
                ...
                <div class="text-center group">
                    <div
                        class="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-green-200 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    <div class="aspect-video bg-gradient-to-br from-blue-500 to-purple-600 relative">
                        ...
                        <div
                            class="absolute top-4 right-4 bg-yellow-400 text-gray-900 px-3 py-1 rounded-full text-sm font-semibold">
                            Populer
                        </div>
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-2">Web Development</h3>
                        <p class="text-gray-600 mb-4">Pelajari HTML, CSS, JavaScript, dan framework modern untuk menjadi web
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Kuasai Python, Machine Learning, dan Data Analysis untuk karir di
                            bidang data science</p>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2">
                                <i class="fas fa-star text-yellow-400"></i>
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Pelajari prinsip desain, Figma, dan user experience untuk menjadi
                            UI/UX designer</p>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-2">
                                <i class="fas fa-star text-yellow-400"></i>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-600 mb-8">
                        Dengan pengajar berpengalaman, materi berkualitas tinggi, dan sistem pembelajaran yang fleksibel,
                ...
                <div class="relative">
                    <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80"
                        alt="About TheSkills" class="rounded-xl shadow-lg">
                </div>
            </div>
        </div>
    </section>
