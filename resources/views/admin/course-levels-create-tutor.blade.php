...
<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Add Course Level</h1>
                <p class="text-gray-600 mt-2">Create a new course difficulty level</p>
            </div>
    ...
    <div class="max-w-2xl mx-auto">
        <form method="POST" action="{{ route('admin.course-levels.store') }}" class="space-y-8">
            @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Describe what this level represents">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
