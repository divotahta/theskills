    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('admin.courses.contents.edit', [$course, $courseContent]) }}" 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-3">
                    <form method="POST" action="{{ route('admin.courses.contents.toggle-status', [$course, $courseContent]) }}">
                        @csrf
                        @method('PATCH')
                        <button type="submit" 
                    ...
                    <form method="POST" action="{{ route('admin.courses.contents.destroy', [$course, $courseContent]) }}" 
