<x-student-layout>
    <x-slot name="header">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Manage your personal information and learning preferences</p>
        </div>
    </x-slot>
                    ...
                    <div class="relative mb-4 md:mb-0 md:mr-6">
                        ...
                        @else
                            <div class="w-24 h-24 rounded-full border-4 border-white shadow-lg bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
                                <span class="text-3xl text-white font-bold">{{ substr($user->name, 0, 1) }}</span>
                            </div>
                        @endif
                        <div class="absolute -bottom-1 -right-1">
                            <a href="{{ route('student.profile.edit') }}" 
                               class="bg-white text-blue-600 rounded-full p-2 shadow-lg hover:bg-blue-50 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center p-4 bg-gray-50 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900">{{ \Carbon\Carbon::parse($user->date_of_birth)->format('M d, Y') }}</p>
                                </div>
                            </div>
                            @endif
    ...
    <script>
        ...
        document.getElementById('cover-photo-input').addEventListener('change', function(e) {
            ...
            if (file) {
                ...
                // Upload file
                fetch('{{ route("student.profile.update-cover") }}', {
                    method: 'POST',
                    body: formData
                })
