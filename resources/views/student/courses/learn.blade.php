<x-student-layout>
        ...
        <div class="flex h-screen">
            ...
            <div class="w-80 bg-white border-r border-gray-200 flex flex-col">
                ...
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="text-xs text-gray-500 mt-1" id="progress-text">0 dari {{ $course->contents->count() }} materi selesai</p>
                </div>
            ...
            <div class="flex-1 flex flex-col">
                ...
                <div class="bg-white border-b border-gray-200 px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            <button onclick="markAsCompleted()" class="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100" id="complete-btn">
    ...
    <script>
        ...
        // Progress tracking
        let completedContents = JSON.parse(localStorage.getItem('completed_contents_' + {{ $course->id }}) || '[]');
        ...
        function updateProgress() {
            ...
            document.getElementById('progress-text').textContent = `${completedCount} dari ${totalContents} materi selesai`;
        }

        function markAsCompleted() {
            if (!currentContentId) return;
            
            if (!completedContents.includes(currentContentId)) {
                completedContents.push(currentContentId);
                localStorage.setItem('completed_contents_' + {{ $course->id }}, JSON.stringify(completedContents));
                updateProgress();
                ...
                showNotification('Materi ditandai sebagai selesai!', 'success');
            }
        }
