...
<div>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('instructor.courses.contents.show', [$course, $courseContent]) }}" 
    ...
    <div class="max-w-4xl mx-auto">
        <form method="POST" action="{{ route('instructor.courses.contents.update', [$course, $courseContent]) }}" class="space-y-8">
            @csrf
            @method('PUT')
