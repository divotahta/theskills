...
@section('content')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Course Learning Interface</p>
            </div>
            ...
            <div class="w-80 bg-white border-r border-gray-200 flex flex-col">
                                            ...
                                            @else
                                                <div class="p-2 text-center">
                                                    ...
                                                    <a href="{{ route('instructor.courses.contents.create', $course) }}?topic={{ $topic->id }}" 
                                                       class="text-xs text-blue-600 hover:text-blue-700">Add content</a>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                ...
                <div class="p-4 border-t border-gray-200">
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('instructor.courses.topics.create', $course) }}" 
                           class="w-full flex items-center justify-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 text-sm font-medium">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                            </svg>
                            Add Topic
    ...
    <script>
        ...
        function toggleContentCompletion() {
            ...
            // Make API call
            fetch(`{{ route('instructor.courses.toggle-progress', $course) }}`, {
                method: 'POST',
                headers: {
