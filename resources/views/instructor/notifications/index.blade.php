...
<div x-data="{ mobileMenuOpen: false }">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
        <form method="GET" action="{{ route('instructor.notifications.index') }}" class="flex flex-wrap items-center gap-4">
            <!-- Type Filter -->
            <div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="mt-4 flex items-center space-x-4">
                                    <a href="{{ route('instructor.notifications.show', $notification) }}" 
...
function markAsUnread(notificationId) {
    fetch(`/instructor/notifications/${notificationId}/mark-unread`, {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
            'Content-Type': 'application/json',
