            ...
            <div class="max-w-full px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                                ...
                                <div x-show="open" @click.away="open = false"
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <a href="{{ route('student.courses.index', ['category' => 'development']) }}"
                                                class="flex items-center space-x-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-gray-50 p-2 rounded-md">
                                            ...
                                            <a href="{{ route('student.courses.index', ['category' => 'business']) }}"
                                                class="flex items-center space-x-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-gray-50 p-2 rounded-md">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <a href="{{ route('student.courses.index', ['category' => 'design']) }}"
                                                class="flex items-center space-x-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-gray-50 p-2 rounded-md">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <a href="{{ route('student.courses.index', ['category' => 'marketing']) }}"
                                                class="flex items-center space-x-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-gray-50 p-2 rounded-md">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <a href="{{ route('student.courses.index', ['category' => 'it-software']) }}"
                                                class="flex items-center space-x-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-gray-50 p-2 rounded-md">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <a href="{{ route('student.courses.index', ['category' => 'personal-development']) }}"
                                                class="flex items-center space-x-2 text-sm text-gray-700 hover:text-blue-600 hover:bg-gray-50 p-2 rounded-md">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <div class="mt-4 pt-3 border-t border-gray-100">
                                            <a href="{{ route('student.courses.index') }}"
                                                class="flex items-center justify-between text-sm text-blue-600 hover:text-blue-700">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-8">
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="text-sm font-semibold text-gray-700 hover:text-gray-900 px-4 py-2 border border-transparent rounded-md">
                                Log in
                            </a>
                            <a href="{{ route('register') }}"
                                class="text-sm font-semibold text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-md">
                                Sign up
                            </a>
