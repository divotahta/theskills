                ...
                <div class="relative flex flex-col w-full max-w-xs pb-4 bg-white">
                    ...
                    <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                        ...
                        <nav class="px-2 mt-5 space-y-1">
                            ...
                            <a href="{{ route('student.courses.index') }}" class="flex items-center px-2 py-2 text-base font-medium text-gray-600 rounded-md hover:bg-gray-50 hover:text-gray-900">
                    ...
                    <div class="flex flex-col flex-1 min-h-0 bg-white border-r border-gray-200">
                        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                            ...
                            <nav class="flex-1 px-2 mt-5 space-y-1 bg-white">
                                ...
                                <a href="{{ route('student.courses.index') }}" class="flex items-center px-2 py-2 text-sm font-medium text-gray-600 rounded-md hover:bg-gray-50 hover:text-gray-900">
